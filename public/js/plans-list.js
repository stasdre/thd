...
/***/ "./resources/assets/js/plans-list.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/plans-list.js ***!
  \*******************************************/
/*! no exports provided */
...
Handlebars.registerHelper("numberFormat", function (options) {
  return Object(_helpers_js__WEBPACK_IMPORTED_MODULE_0__["number_format"])(options.fn(this));
});
var source = document.getElementById("quickView-tpl").innerHTML;
var template = Handlebars.compile(source);
$(document).ready(function () {
  $("body").on('click', '.dwhp-like-plan', function (e) {
    e.preventDefault();
    var thisObj = $(this);
    var heartIcon = thisObj.find("i.fa-heart");
  ...
  $(".dwhp-quick-view-plan").on('click', function (e) {
    ...
    $.ajax({
      method: 'GET',
      url: "/get-plan-data/".concat(planId),
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      }
    }).done(function (data) {
...
/***/ 5:
/*!*************************************************!*\
  !*** multi ./resources/assets/js/plans-list.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/stasdre/server/dwhp/resources/assets/js/plans-list.js */"./resources/assets/js/plans-list.js");
