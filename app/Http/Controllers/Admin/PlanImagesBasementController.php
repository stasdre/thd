...
use Thd\PlanImageBasement;

class PlanImagesBasementController extends Controller
{
    /**
     ...
     */
    public function edit(PlanImageBasement $image)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PlanImageBasement $image)
    {
        $input = $request->all();
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($request->input('sortable_id') as $key=>$image){
            PlanImageBasement::where('id', $image)->update(['sort_number'=>$key]);
        }
