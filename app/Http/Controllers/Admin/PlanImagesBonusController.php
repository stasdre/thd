...
use Thd\PlanImageBonus;

class PlanImagesBonusController extends Controller
{
    /**
     ...
     */
    public function edit(PlanImageBonus $image)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PlanImageBonus $image)
    {
        $input = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(PlanImageBonus $image)
    {
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($request->input('sortable_id') as $key=>$image){
            PlanImageBonus::where('id', $image)->update(['sort_number'=>$key]);
        }
