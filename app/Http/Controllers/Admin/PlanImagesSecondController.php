...
use Thd\PlanImageSecond;

class PlanImagesSecondController extends Controller
{
    /**
     ...
     */
    public function edit(PlanImageSecond $image)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, PlanImageSecond $image)
    {
        $input = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(PlanImageSecond $image)
    {
    ...
    public function sort(Request $request)
    {
        ...
        foreach ($request->input('sortable_id') as $key=>$image){
            PlanImageSecond::where('id', $image)->update(['sort_number'=>$key]);
        }
