...
@section('carousel')
    <div id="banner" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/2.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/3.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/4.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/5.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/6.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/7.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
            ...
            <div class="carousel-item"> <img class="d-block w-100" src="/images/banner/8.jpg" alt="Second slide">
                <div class="caption-quote-wrap">
                    <div class="caption-quote"> "FAMILIES LOVE THIS COZY CRAFTSMAN COTTAGE WITH FABULOUS WRAPAROUND PORCH" </div>
                    <p class="caption-quote-author">DAVID E. WIGGINS</p>
                </div>
...
@section('content')
    ...
    <div class="bg-secondary py-3 px-5 text-center home-about">
        <div class="row align-items-center">
            <div class="col-sm-6"> <img src="/images/david.png" alt="David" class="img-fluid" /> </div>
            <div class="col-sm-6">
                <h4 class="font-weight-bold mb-3">About David E. Wiggins, Architect</h4>
                <p>David E Wiggins, Architect is one of the nation’s leading home designers<br>and providers of stock house plans. His interest in stock house plans<br>rose out of a perceived need to provide affordable, high quality home<br>designs to the masses. This venue also presents a freedom to be creative<br>in a way that custom designs for specific clients or builders cannot.</p>
                ...
                <p><a data-fancybox="" href="https://www.youtube.com/watch?v=-C6nkFbiGW4" class="btn btn-outline-dark rounded-0 px-5 font-weight-semi-bold">Watch the Video</a></p>
            </div>
        </div>
    </div>
    <div class="py-3">
...
@section('mobile-new')
    <div class="container">
        <img src="/images/plan-cta-2.jpg" alt="New House Plans" class="img-fluid w-100 my-2">
    </div>
@endsection
