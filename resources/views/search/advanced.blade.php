  ...
  <div class="sidebar-left col-md-5 col-lg-3">
                ...
                <tr>
                  <td colspan="2">
                    <div class="search-button">
                      <button class="btn btn-primary rounded-0 text-white font-weight-semi-bold" type="submit"> View
    ...
    <div class="row">
      <div class="col-sm-12 center">
        <div class="plan-cta position-relative mb-2 only_under_767" style="font-size: 16px;line-height: 29px;">
          <div class="font-weight-bold view_plans">Sign Up + Save : <input type="text" placeholder="Enter email address"
              class="text-center asp-save"></div>
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row mobile-off">
      <div class="col-sm-12">
        <div class="plan-cta position-relative mb-2">
          <div class="search-button">
            <button class="btn btn-primary rounded-0 text-white font-weight-semi-bold with_padding" type="submit"> View
              Search Results</button>
          </div>
        </div>
