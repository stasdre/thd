    ...
    <div class="col-md-7 col-lg-9 mobile-off">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <li class="list-inline-item icon-heart-mob"><a href="#"><i class="fa fa-heart-o" style="color:white"></i></a></li>
              <li class="list-inline-item icon-search-mob"><a href="#"  data-toggle="modal" data-target="#quickView"><i class="fa fa-search" style="color:white"></i></a></li>
            </ul>
                  </div>  
                </div>
