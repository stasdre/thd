    ...
    <div class="row align-items-center">
        <div class="col-md-3 col-sm-3 px-xs-0 width-sm-100">
            <div class="navbar-expand-lg navbar-dark bg-dark custom_nav d-block d-sm-block d-md-none">
                <span class="float-left">
                    ...
                    <a class="d-inline-block align-middle" href="{{route('home')}}"><img
                            src="{{asset('images/icons/logo.png')}}" alt="" class="img-fluid mr-2"
                ...
                <span class="float-right">
                    <a href="#"
                        ...
                        style="font-size:10px" data-toggle="dropdown" role="button" aria-haspopup="true"
                        aria-expanded="false"><i class="fa fa-search d-block"
                            style="font-size:16px; margin-right: 10px;"></i></a>
                    ...
                    <a href="tel:832-521-5820"
                        class="d-inline-block text-center text-white small align-middle xs-display"
                        style="font-size:10px"><i class="fa fa-phone d-block"
                            style="font-size:16px; margin-right: 10px;"></i></a>
                    <a href="/saved-plans" class="d-inline-block text-center text-white small align-middle xs-display"
                        style="font-size:10px"><i class="fa fa-user d-block"
                            style="font-size:16px; margin-right: 10px;"></i></a>
                    <a href="{{route('cart')}}"
                        class="d-inline-block text-center text-white small align-middle xs-display"
            ...
            <nav class="navbar navbar-dark navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="mb-0 p-0 width_100">
                        <li class="list-inline-item dropdown d-lg-none"><a href="{{ route('contact-us') }}">Email</a>
                        </li>
                        <li class="list-inline-item dropdown d-lg-none"><a href="{{ route('contact-us') }}">Contact</a>
                        </li>
                        <li class="list-inline-item dropdown d-lg-none"><a href="tel:832-521-5820">Phone</a></li>
                        <li class="list-inline-item dropdown"> <a class="dropdown-toggle" data-toggle="dropdown"
                                role="button" aria-haspopup="true" aria-expanded="false" href="#link"><img
                        ...
                        <li class="list-inline-item"><a
                                href="/blog/customers-share-their-home-building-experience/">Reviews</a>
                        </li>
        ...
        <div class="col-md-2 col-sm-3 xs-set-position d-none d-lg-block">
            <ul class="list-inline text-center text-sm-right text-small text-uppercase mt-1 mb-3">
                ...
                <li class="list-inline-item"><a href="{{route('cart')}}"><img
                            src="{{ asset('images/icons/icon-cart.png') }}" alt="" class="img-fluid"></a></li>
            </ul>
