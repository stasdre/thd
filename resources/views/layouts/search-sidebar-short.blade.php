                                ...
                                <td colspan="2">
                                    <div class="">
                                        <button class="btn btn-primary rounded-0 text-white font-weight-semi-bold"
                                            type="submit" style="width :100%;"> SEARCH</button>
                                    </div>
                                    <div class="text-right advanced_search_text" style="margin-top : -10px;"><a
                                            href="{{ route('advanced-search') }}" class="red-links"> ADVANCED PLAN
                                            SEARCH</a></div>
                                </td>
                            </tr>
