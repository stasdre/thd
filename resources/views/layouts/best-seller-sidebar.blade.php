<div class="col-12 col-md-4 contact-us-right-sidebar mobile-off">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h5 style="font-weight: bold;font-size: 18px;" class="contact-right-sidebar-heading">View Our Best-Selling House Plans</h5>
    ...
    <div class="row">
        <div class="col-md-12 mt-3 black_banner" style="background-image:url('images/black-banner.jpg');">
            <div class="text-center blackBanner">
                ...
                <input name="email" class="email_class text-center" type="text"  placeholder="Enter your email address" style="width : 75%;"><br>
