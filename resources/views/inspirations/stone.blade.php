...
<div class="center mid-heading stone-heading py-3">
    <h1 class="blue-text font_20">BEAUTIFUL STONE VENEER FOR YOUR NEW HOME</h1>
</div>
<div class="">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 padding_0">
            ...
            <div class="fullcls"><a href="/stone-header-1" target="_blank"><img
                        src="/images/stone-header-1.png"></a></div>
            ...
            <div class="row">
                <div class="col-4 images_width slider_img_padding pedding-right7">
                    <div style=""><a href="/stone-header-2" target="_blank"><img
                                src="/images/stone-header-2.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding pedding-right7">
                    <div style=""><a href="/stone-header-3" target="_blank"><img
                                src="/images/stone-header-3.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding pedding-right7">
                    <div style="" class=""><a href="/stone-header-4" target="_blank"><img
                                src="/images/stone-header-4.png"></a></div>
                </div>
            </div>
        </div>
