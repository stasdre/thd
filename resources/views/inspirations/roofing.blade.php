...
@section('content')
<div class="center mid-heading roof-heading py-3">
    <h1 class="blue-text font_20">PERFORMANCE ROOFING FOR YOUR NEW HOME</h1>
</div>
...
<div class="">
    <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-4 col-xs-12 sidebar_background_roof top-row">
            <div class="row">
                <div class="col-lg-12 col-md-4 col-sm-12">
                    <div class="roof_side_1 ipad-off"><a
                            href="https://www.gaf.com/en-us/roofing-products/residential-roofing-products/shingles/designer/ultra-premium/grand-canyon"><img
                                src="/images/roofing-sidebar-1.png"></a></div>
                    <div class="roof_side_logo center HI-product-logo"><img
                            src="/images/roofing-sidebar-logo.png"></div>
                </div>
                <div class="col-lg-12 col-md-8 col-sm-12">
                    <div class="center sidebar_text exterior_sidebar_text">
                        <p class="font_mob">With a 130 year legacy of quality and innovation,
                            GAF offers roofing solutions that keep moisture out, your energy costs
                            down and your house looking terrific.</p>
        ...
        <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 padding_0">
            <div class="fullcls"><a
                    href="https://www.gaf.com/en-us/roofing-products/residential-roofing-products/shingles/designer/ultra-premium/glenwood"
                    target="_blank"><img src="/images/roofing_header-1.png"></a></div>
            ...
            <div class="row">
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a
                            href="https://www.gaf.com/en-us/roofing-products/residential-roofing-products/shingles/timberline/architectural/timberline-hd"
                            target="_blank"><img src="/images/roofing_header-2.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a
                            href="https://www.gaf.com/en-us/roofing-products/residential-roofing-products/shingles"
                            target="_blank"><img src="/images/roofing_header-3.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a
                            href="https://www.gaf.com/en-us/roofing-products/residential-roofing-products/shingles/designer/ultra-premium/glenwood"
                            target="_blank"><img src="/images/roofing_header-4.png"></a></div>
                </div>
            </div>
        </div>
    </div>
    <hr class="black_border">
    <h3 class="center text-bold pro_dsc text_uppercase" style="font-size: 22px; ">Innovative
        Products to Design Functional and Beautiful Living Spaces</h3>
