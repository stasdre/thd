...
<div class="center mid-heading roof-heading py-3">
    <h1 class="blue-text font_20">SIDING THAT ELEVATES YOUR NEW HOME</h1>
</div>
<div class="">
    <div class="row">
        <div class="col-lg-3 col-md-12 sm-4 col-xs-12 sidebar_background_exterior top-row">
            <div class="row">
                <div class="col-lg-12 col-md-4 col-sm-12">
                    ...
                    <div class="exterior_side_logo center"><img
                            src="/images/royalbuildingproducts.png"></div>
                </div>
                <div class="col-lg-12 col-md-8 col-sm-12">
                    <div class="center sidebar_text exterior_sidebar_text">
                        <p class="font_mob">Offering the most trim lines, profiles and colors,
        ...
        <div class="col-lg-9 col-md-12 sm-8 col-xs-12 padding_0">

            <div class="fullcls"><a href="/exterior-header-1" target="_blank"><img
                        src="/images/exterior-header-1.png"></a></div>
            ...
            <div class="row">
                <div class="col-4 images_width slider_img_padding">
                    <div style=""><a href="/exterior-header-2" target="_blank"><img
                                src="/images/exterior-header-2.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div style=""><a href="/exterior-header-3" target="_blank"><img
                                src="/images/exterior-header-3.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div style="" class=""><a href="/exterior-header-4" target="_blank"><img
                                src="/images/exterior-header-4.png"></a></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Crousel -->
    <div id="carousel3" class="carousel slide font_16 desktop-off" data-ride="carousel"
        data-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="slides row center">
            ...
            <div class="carousel-item">
                <div class="slides row center">
                    <div class="col-12">
                        <div style=""><img src="/images/Benjamin-Moore-Paint.png"></div>
                        <div class="p_title center font_16">Benjamin Moore Paint </div>
                        <div><a href="" class="HP_links font_16">View All Products <i
                                    class="fa fa-chevron-right"></i></a></div>
                    </div>
                </div>
