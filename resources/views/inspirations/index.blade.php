                    ...
                    <div class="d-flex flex-column justify-content-between align-items-center blue-bg">
                        ...
                        <div>
                            ...
                            <div class="bottom-text">
                                ...
                                <a target="_blank" href="{{$slider->brochure_link}}"><span style="color:#fff;"
                                        class="bottom-text-left">View
                                        brochure</span></a> |
                                @endif
                                @if ($slider->locator_link)
                                <a target="_blank" href="{{$slider->locator_link}}"><span style="color:#fff;"
                                        class="bottom-text-right">Product
                                        locator</span></a>
                                @endif
                            </div>
                            @endif
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="inspiration-slider embed-responsive embed-responsive-4by3">
                        <img class="embed-responsive-item"
                            src="{{asset('storage/inspiration-slider/'.$slider->slider_img)}}">
                    </div>
                    @endif
                </div>
            </div>
...
<div class="row HI-secC py-2">
    <div class="col-12 col-md-6 center">
        ...
        <div class="py-2">
            ...
            <div><a target="_blank" href="{{$blocks->link_l_t}}" class="HP_links">{{$blocks->link_name_l_t}}<i
    ...
    <div class="col-12 col-md-6 center">
        ...
        <div class="py-2">
            ...
            <div><a target="_blank" href="{{$blocks->link_r_t}}" class="HP_links">{{$blocks->link_name_r_t}}<i
                        class="fa fa-chevron-right"></i></a></div>
            @endif
        </div>
    </div>
                ...
                <div class="slides row center">
                    <div class="col-12">
                        <div class="embed-responsive embed-responsive-1by1">
                            <img class="embed-responsive-item"
                                src="{{asset('storage/inspiration-products/'.$product->img)}}">
                        </div>
                        <div class="p_title center">{{$product->name}}</div>
                        <div>
                            @if ($product->link_name && $product->link)
                            <a target="_blank" href="{{$product->link}}" class="HP_links">{{$product->link_name}} <i
...
<div class="row py-3 HI-secE">
    <div class="col-12 col-md-6 center">
        ...
        <div class="py-2">
            ...
            <div><a target="_blank" href="{{$blocks->link_b_l}}" class="HP_links">{{$blocks->link_name_b_l}}<i
                        class="fa fa-chevron-right"></i></a></div>
            @endif
        </div>
    </div>
    <div class="col-12 col-md-6 center">
        ...
        <div class="py-2">
            ...
            <div><a target="_blank" href="{{$blocks->link_b_r}}" class="HP_links">{{$blocks->link_name_b_r}}<i
                        class="fa fa-chevron-right"></i></a></div>
            @endif
        </div>
    </div>
