...
@section('content')
<div class="center mid-heading mid-heading2 py-3">
    <h1 class="blue-text font_23">BEAUTIFUL WINDOWS FOR YOUR NEW HOME</h1>
</div>
...
<div class="">
    <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-4 col-xs-12 sidebar_background top-row">
            <div class="row">
                <div class="col-lg-12 col-md-4 col-sm-12">
                    <div class="ipad-off"><a
                            href="https://www.jeld-wen.com/en-us/products/windows/custom-wood"><img
                                src="/images/windows-sidebar-1.png"></a></div>
                    <div class="center top35"><img src="/images/windows-sidebar-logo.png"></div>
                </div>
                <div class="col-lg-12 col-md-8 col-sm-12">
                    <div class="center sidebar_text exterior_sidebar_text">
                        <p class="font_mob">Windows that inspire and set your home
                            apart with brilliant design and powerful performance in both custom wood
                            and vinyl maintenance free options.</p>
        ...
        <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 padding_0">
            ...
            <div class="fullcls wind_jeld_img1"><a
                    href="https://www.jeld-wen.com/en-us/products/windows/epicvue-wood"
                    target="_blank"><img src="/images/windows-header-1.png"></a></div>
            ...
            <div class="row">
                <div class="col-4 images_width slider_img_padding">
                    <div class="wind_jeld_img2"><a
                            href="https://www.jeld-wen.com/en-us/products/windows/epicvue-wood"
                            target="_blank"><img src="/images/windows-header-2.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="wind_jeld_img3"><a
                            href="https://www.jeld-wen.com/en-us/products/windows"
                            target="_blank"><img src="/images/windows-header-3.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="wind_jeld_img4"><a
                            href="https://www.jeld-wen.com/en-us/products/windows/siteline-clad-wood"
                            target="_blank"><img src="/images/windows-header-4.png"></a></div>
                </div>
            </div>
        </div>
    ...
    <div class="row py-3 center mobile-off insipiration_below_slider_outer">
        <div class="col-3">
            <div style=""><img src="/images/windows-project-1.png"></div>
