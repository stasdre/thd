...
<div class="">
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <a target="_blank" href="{{$data->first_img_link}}" target="_blank">
            <div class="embed-responsive embed-responsive-4by3"><img class="embed-responsive-item"
                src="{{asset('storage/inspiration/'.$data->first_img)}}" /></div>
          </a>
          @else
          <div class="embed-responsive embed-responsive-4by3"><img class="embed-responsive-item"
              src="{{asset('storage/inspiration/'.$data->first_img)}}" /></div>
        ...
        <div class="col-6">
          ...
          <a target="_blank" href="{{$data->second_img_link}}" target="_blank">
            <div class="embed-responsive embed-responsive-4by3"><img class="embed-responsive-item"
                src="{{asset('storage/inspiration/'.$data->second_img)}}" /></div>
          </a>
          @else
          <div class="embed-responsive embed-responsive-4by3"><img class="embed-responsive-item"
              src="{{asset('storage/inspiration/'.$data->second_img)}}" /></div>
        ...
        <div class="col-4">
          ...
          @if ($data->first_img_link)
          <a target="_blank" href="{{$data->first_img_link}}" target="_blank">
            <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
                src="{{asset('storage/inspiration/'.$data->first_img)}}" /></div>
          </a>
          @else
          <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
        ...
        <div class="col-4">
          ...
          <a target="_blank" href="{{$data->third_img_link}}" target="_blank">
            <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
                src="{{asset('storage/inspiration/'.$data->third_img)}}" /></div>
          </a>
          @else
          <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
              src="{{asset('storage/inspiration/'.$data->third_img)}}" /></div>
  ...
  <div class="row py-3 center mobile-off insipiration_below_slider_outer">
    ...
    <div class="col-6 col-lg-3">
      <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
          src="{{asset('storage/inspiration/'.$product->product_img)}}"></div>
      <div class="p_title center">{{$product->title}}</div>
      <div><a href="{{$product->link}}" class="HP_links">View All Products <i class="fas fa fa-chevron-right"></i></a>
      </div>
    </div>
  ...
  <div class="row py-3 center mobile-off insipiration_below_slider_outer">
    @isset ($data->products)
    @foreach ($data->products as $product)
    @continue($loop->iteration < 5) <div class="col-6 col-lg-3">
      <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
          src="{{asset('storage/inspiration/'.$product->product_img)}}"></div>
      <div class="p_title center">{{$product->title}}</div>
      <div><a href="{{$product->link}}" class="HP_links">View All Products <i class="fas fa fa-chevron-right"></i></a>
...
<div id="carousel3" class="carousel slide desktop-off" data-ride="carousel" data-interval="false">
  <div class="carousel-inner">
    @isset ($data->products)
    @foreach ($data->products as $product)
    @continue($loop->iteration < 5) <div class="carousel-item @if($loop->iteration === 5) active @endif">
      <div class="slides row center">
        <div class="col-12">
          <div class="embed-responsive embed-responsive-1by1"><img class="embed-responsive-item"
              src="{{asset('storage/inspiration/'.$product->product_img)}}"></div>
