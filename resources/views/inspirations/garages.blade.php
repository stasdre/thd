...
<div class="center mid-heading roof-heading py-3">
    <h1 class="blue-text font_20">STYLISH GARAGE DOORS FOR YOUR NEW HOME</h1>
</div>
...
<div class="">
    <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-8 col-xs-12 padding_0">
            <div class="fullcls"><a href="/Home-Inspiration-Garag-03" target="_blank"><img
                        src="/images/Home-Inspiration-Garag-03.png"></a></div>
            <div class="center view_product mobile-off grey-text">Click any image to view product
            </div>
            <div class="row HP-pageimages">
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a href="/garage_amarr_02" target="_blank"><img
                                src="/images/garage_amarr_02.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a href="/garage_amarr_03" target="_blank"><img
                                src="/images/garage_amarr_03.png"></a></div>
                </div>
                <div class="col-4 images_width slider_img_padding">
                    <div class="roofing"><a href="/garage_amarr_04" target="_blank"><img
                                src="/images/garage_amarr_04.png"></a></div>
                </div>
            </div>
        </div>
    </div>
