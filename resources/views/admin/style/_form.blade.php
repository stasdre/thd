    ...
    <div class="tab-pane fade in active" id="main">
            ...
            <div class="col-sm-5">
                <div class="input-group input-group-sm">
                    @if(isset($style->image))
                        ...
                        <p class="file-name">/styles/{{ $style->image }} <a href="#" class="delete-file" style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
                    @else
        ...
        @if(isset($style->image))
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="edit-img"><a href="{{asset('/storage/styles/'.$style->image)}}" target="_blank"><img src="{{asset('/storage/styles/'.$style->image)}}" data-origin="/storage/styles/{{$style->image}}" class="img-responsive" alt=""></a></div>
                    <div class="edit-img"><a href="{{asset('/storage/styles/thumb/'.$style->image)}}" target="_blank"><img src="{{asset('/storage/styles/thumb/'.$style->image)}}" data-origin="/storage/styles/{{$style->image}}" class="img-responsive" alt=""></a></div>
                </div>
            </div>
        @endif
        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( old('plan_img_old.'.$loop->index) )
                                    ...
                                    <img width="100" height="100" src="/storage/styles/thumb/{{ old('plan_img_old.'.$loop->index) }}" alt="" class="img-thumbnail">
                                @endif
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="added-plan">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <img width="100" height="100" src="/storage/styles/thumb/{{ $plan->img }}" alt="" class="img-thumbnail">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Alt Tag</label>
...
<script>
    $(function(){
       $("#add-plans").on('click', function(){
        ...
        $("#styles-submit-close, #styles-submit-next").on('click', function(e){
            e.preventDefault();
            if( $(this).prop('id') == 'styles-submit-close' )
                $('#redirect').val('close');
            else
                $('#redirect').val('next');
