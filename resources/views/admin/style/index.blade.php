...
<div class="box box-default">
    ...
    <div class="box-body">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#details" aria-controls="details" role="tab" data-toggle="tab">Styles
                    Details</a>
            </li>
        </ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="edit-img"><a href="{{asset('/storage/styles/'.$data->image)}}" target="_blank"><img
                                    ...
                                    data-origin="/storage/styles/original/{{$data->image}}" class="img-responsive"
                                    alt=""></a></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-5">
                        <div class="edit-img"><a href="{{asset('/storage/styles/thumb/'.$data->image)}}"
                                target="_blank"><img src="{{asset('/storage/styles/thumb/'.$data->image)}}"
                                    data-origin="/storage/styles/original/{{$data->image}}" class="img-responsive"
                                    alt=""></a></div>
                    </div>
                </div>
