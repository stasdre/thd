...
<div id="file_upload_first" class="dropzone needsclick dz-clickable">
    <div class="dz-message needsclick">
        Drop files here or click to upload.<br>
    </div>
    <div id="files_sortable_first">
        @foreach($planImagesFirst as $image)
            <div class="dz-preview dz-processing sending dz-image-preview file_sortable dz-complete" id="sortable_id_{{ $image->id }}">
                ...
                <a class="remov_image_first" href="#">Remove file</a>
            </div>
        @endforeach
    </div>
</div>
