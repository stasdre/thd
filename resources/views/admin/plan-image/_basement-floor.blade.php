...
<div id="file_upload_basement" class="dropzone needsclick dz-clickable">
    <div class="dz-message needsclick">
        Drop files here or click to upload.<br>
    </div>
    <div id="files_sortable_basement">
        @foreach($planImagesBasement as $image)
            <div class="dz-preview dz-processing sending dz-image-preview file_sortable dz-complete" id="sortable_id_{{ $image->id }}">
                <div class="imag_container downloaded_without_check_basement" id="image_id_{{ $image->id }}">
                ...
                <a class="remov_image_basement" href="#">Remove file</a>
            </div>
        @endforeach
    </div>
</div>
