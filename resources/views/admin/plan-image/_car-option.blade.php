...
<div id="file_upload_car-option" class="dropzone needsclick dz-clickable">
    <div class="dz-message needsclick">
        Drop files here or click to upload.<br>
    </div>
    <div id="files_sortable_car-option">
        @foreach($planImagesCar as $image)
            <div class="dz-preview dz-processing sending dz-image-preview file_sortable dz-complete" id="sortable_id_{{ $image->id }}">
                <div class="imag_container downloaded_without_check_car-option" id="image_id_{{ $image->id }}">
                ...
                <a class="remov_image_car-option" href="#">Remove file</a>
            </div>
        @endforeach
    </div>
</div>
