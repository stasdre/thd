...
<div class="box box-default">
  {!! Form::model($data, ['route' => 'about-david.update', 'class' => 'form-horizontal', 'method' => 'post',
  'enctype'=>'multipart/form-data']) !!}
  <div class="box-body">
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active"><a href="#about" aria-controls="general" role="tab" data-toggle="tab">About
          David</a></li>
      ...
      <li role="presentation"><a href="#free" aria-controls="details" role="tab" data-toggle="tab">Free modification</a>
      </li>
    ...
    <div class="tab-content">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <div class="input-group input-group-sm">
              ...
              <p id="file-name">/about/{{ $data->photo }} <a href="#" id="delete-file"
      ...
      <div role="tabpanel" class="tab-pane fade in" id="meta">
        <div class="form-group">
          {{ Form::label('meta[title]', 'Title', ['class' => 'col-sm-2 control-label']) }}
          <div class="col-sm-10">
            {{ Form::text('meta[title]', null, ['class'=>'form-control', 'placeholder'=>'Title']) }}
          </div>
        </div>
        <div class="form-group">
          {{ Form::label('meta[description]', 'Description', ['class' => 'col-sm-2 control-label']) }}
          <div class="col-sm-10">
            {{ Form::textarea('meta[description]', null, ['class'=>'form-control']) }}
          </div>
        </div>
        <div class="form-group">
          {{ Form::label('meta[keywords]', 'Keywords', ['class' => 'col-sm-2 control-label']) }}
          <div class="col-sm-10">
