@if(Route::currentRouteName() == 'mobile-gallery.edit')
{{ Form::model($gallery, ['route' => ['mobile-gallery.update', $gallery->id], 'class' => 'form-horizontal', 'method' => 'PATCH', 'enctype'=>'multipart/form-data']) }}
@else
{!! Form::open(['route' => 'mobile-gallery.store', 'class' => 'form-horizontal', 'method' => 'post',
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <div class="input-group input-group-sm">
        ...
        <p id="file-name">/gallery/{{ $gallery->file }} <a href="#" id="delete-file"
...
<div class="box-footer">
  {{ link_to_route('mobile-gallery.index', 'Cancel', [], ['class'=>'btn btn-default', 'role'=>'button']) }}
