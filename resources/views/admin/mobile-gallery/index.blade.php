...
@section('title', 'Home Page Mobile Gallery')
...
@section('content')
    <div class="box box-default">
        <div class="box-header">
            <a class="btn btn-primary" href="{{ route('mobile-gallery.create') }}" role="button">Create new slide</a>
        </div>
        <div class="box-body">
...
<script>
    $(function() {
        $('#styles-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('mobile-gallery.data') !!}',
            columns: [
