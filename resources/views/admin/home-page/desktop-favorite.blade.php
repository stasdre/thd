...
<div class="box box-default">
    ...
    <div class="box-body">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#first" aria-controls="details" role="tab"
                    data-toggle="tab">First</a></li>
            ...
            <li role="presentation"><a href="#fourth" aria-controls="details" role="tab" data-toggle="tab">Fourth</a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade in" id="fourth">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group input-group-sm">
                            ...
                            <span class="input-group-addon file-input hidden"> <i class="fa fa-file"
                                    aria-hidden="true"></i></span>
                            <p class="file-name">/home-page/{{ $data->fourth_file }} <a href="#" class="delete-file"
                                    style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
                            @else
                ...
                <div class="form-group {{ $errors->has('fourth_plan_link') ? 'has-error' : '' }}">
                    {{ Form::label('fourth_plan_link', 'Plan link', ['class' => 'col-sm-2 control-label']) }}
                    <div class="col-sm-8">
                        {{ Form::text('fourth_plan_link', null, ['class'=>'form-control', 'placeholder'=>'Plan link']) }}
                    </div>
                </div>
