    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#main" aria-controls="general" role="tab" data-toggle="tab">Main</a></li>
                        ...
                        <div class="col-sm-5">
                            <div class="input-group input-group-sm">
                                @if(isset($data->main_file))
                                    ...
                                    <p class="file-name">/home-page/{{ $data->main_file }} <a href="#" class="delete-file" style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
                                @else
