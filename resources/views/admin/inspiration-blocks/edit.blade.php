...
<div class="box box-default">
  {!! Form::model($data, ['route' => 'inspiration-blocks.update', 'class' => 'form-horizontal', 'method' => 'post',
  'enctype'=>'multipart/form-data']) !!}
  <div class="box-body">
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation" class="active"><a href="#tl" aria-controls="general" role="tab" data-toggle="tab">Top
          left</a></li>
      ...
      <div role="tabpanel" class="tab-pane fade in active" id="tl">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration-blocks/{{ $data->img_l_t }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration-blocks/'.$data->img_l_t)}}"
                target="_blank"><img src="{{asset('/storage/inspiration-blocks/'.$data->img_l_t)}}"
                  data-origin="/storage/inspiration-blocks/original/{{$data->img_l_t}}" class="img-responsive"
                  alt=""></a></div>
            @else
      ...
      <div role="tabpanel" class="tab-pane fade in" id="tr">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration-blocks/{{ $data->img_r_t }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration-blocks/'.$data->img_r_t)}}"
                target="_blank"><img src="{{asset('/storage/inspiration-blocks/'.$data->img_r_t)}}"
                  data-origin="/storage/inspiration-blocks/original/{{$data->img_r_t}}" class="img-responsive"
                  alt=""></a></div>
            @else
      ...
      <div role="tabpanel" class="tab-pane fade in" id="bl">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration-blocks/{{ $data->img_b_l }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration-blocks/'.$data->img_b_l)}}"
                target="_blank"><img src="{{asset('/storage/inspiration-blocks/'.$data->img_b_l)}}"
                  data-origin="/storage/inspiration-blocks/original/{{$data->img_b_l}}" class="img-responsive"
                  alt=""></a></div>
            @else
      ...
      <div role="tabpanel" class="tab-pane fade in" id="br">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration-blocks/{{ $data->img_b_r }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration-blocks/'.$data->img_b_r)}}"
                target="_blank"><img src="{{asset('/storage/inspiration-blocks/'.$data->img_b_r)}}"
                  data-origin="/storage/inspiration-blocks/original/{{$data->img_b_r}}" class="img-responsive"
                  alt=""></a></div>
            @else
