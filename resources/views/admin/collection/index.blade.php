  ...
  <div class="box-body">
    ...
    <div class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane fade in" id="details">
        {!! Form::model($data, ['route' => 'collections.storeData', 'class' => 'form-horizontal', 'id'=>'plans-form',
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
            <div class="edit-img"><a href="{{asset('/storage/collections/'.$data->image)}}" target="_blank"><img
                  src="{{asset('/storage/collections/'.$data->image)}}"
                  data-origin="/storage/collections/original/{{$data->image}}" class="img-responsive" alt=""></a></div>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-2"></div>
          <div class="col-sm-5">
            <div class="edit-img"><a href="{{asset('/storage/collections/thumb/'.$data->image)}}" target="_blank"><img
                  src="{{asset('/storage/collections/thumb/'.$data->image)}}"
                  data-origin="/storage/collections/original/{{$data->image}}" class="img-responsive" alt=""></a></div>
          </div>
        </div>
        @endif
