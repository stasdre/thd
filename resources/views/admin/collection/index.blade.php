...
<div class="box box-default">
    ...
    <div class="box-body">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#details" aria-controls="details" role="tab" data-toggle="tab">Collection
                    Details</a></li>
        </ul>
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade in" id="details">
                {!! Form::model($data, ['route' => 'collections.storeData', 'class' => 'form-horizontal',
                'id'=>'plans-form',
                ...
                <div class="form-group {{ $errors->has('subtitle_link') ? 'has-error' : '' }}">
                    {{ Form::label('subtitle_link', 'Subtitle link', ['class' => 'col-sm-2 control-label']) }}
                    <div class="col-sm-8">
                        {{ Form::text('subtitle_link', null, ['class'=>'form-control', 'placeholder'=>'link']) }}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group input-group-sm">
                            ...
                            <p class="file-name">/collections/{{ $data->image }} <a href="#" class="delete-file"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <div class="edit-img"><a href="{{asset('/storage/collections/'.$data->image)}}"
                                target="_blank"><img src="{{asset('/storage/collections/'.$data->image)}}"
                                    data-origin="/storage/collections/original/{{$data->image}}" class="img-responsive"
                                    alt=""></a></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-5">
                        <div class="edit-img"><a href="{{asset('/storage/collections/thumb/'.$data->image)}}"
                                target="_blank"><img src="{{asset('/storage/collections/thumb/'.$data->image)}}"
                                    data-origin="/storage/collections/original/{{$data->image}}" class="img-responsive"
                                    alt=""></a></div>
                    </div>
                </div>
