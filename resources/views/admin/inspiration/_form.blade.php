...
<div class="box-body">
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#meta" aria-controls="details" role="tab" data-toggle="tab">Meta</a></li>
  </ul>
  <!-- Tab panes -->
  <div class="tab-content">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->img_above_logo }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->img_above_logo)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->img_above_logo)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->img_above_logo}}" class="img-responsive"
                  alt=""></a></div>
            @else
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->logo_img }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->logo_img)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->logo_img)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->logo_img}}" class="img-responsive"
                  alt=""></a>
            </div>
            @else
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->main_img }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->main_img)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->main_img)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->main_img}}" class="img-responsive"
                  alt=""></a>
            </div>
            @else
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->first_img }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->first_img)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->first_img)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->first_img}}" class="img-responsive"
                  alt=""></a>
            </div>
            @else
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->second_img }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->second_img)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->second_img)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->second_img}}" class="img-responsive"
                  alt=""></a></div>
            @else
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4 input-file">
            ...
            <p class="file-name">/inspiration/{{ $inspiration->third_img }} <a href="#" class="delete-file"
                style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
            <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$inspiration->third_img)}}"
                target="_blank"><img src="{{asset('/storage/inspiration/'.$inspiration->third_img)}}"
                  data-origin="/storage/inspiration/original/{{$inspiration->third_img}}" class="img-responsive"
                  alt=""></a>
            </div>
            @else
        ...
        <div class="product__container">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4 input-file">
              ...
              <p class="file-name">/inspiration/{{ $item->product_img }} <a href="#" class="delete-file"
                  style="margin-left: 15px; color: red;"><i class="fa fa-ban"></i></a></p>
              <div class="edit-img"><a href="{{asset('/storage/inspiration/'.$item->product_img)}}" target="_blank"><img
                    src="{{asset('/storage/inspiration/'.$item->product_img)}}"
                    data-origin="/storage/inspiration/original/{{$item->product_img}}" class="img-responsive"
                    alt=""></a>
              </div>
              @else
              {{ Form::file('products['.$key.'][product_img]', ['class'=>'form-control']) }}
    ...
    <div role="tabpanel" class="tab-pane fade in" id="meta">
      <div class="form-group">
        {{ Form::label('meta_title', 'Title', ['class' => 'col-sm-2 control-label']) }}
        <div class="col-sm-4">
          {{ Form::text('meta_title', null, ['class'=>'form-control', 'placeholder'=>'Title']) }}
        </div>
      </div>
      <div class="form-group">
        {{ Form::label('meta_desc', 'Descripton', ['class' => 'col-sm-2 control-label']) }}
        <div class="col-sm-10">
          {{ Form::textarea('meta_desc', null, ['class'=>'form-control']) }}
        </div>
      </div>
      <div class="form-group">
        {{ Form::label('meta_keywords', 'Keywords', ['class' => 'col-sm-2 control-label']) }}
        <div class="col-sm-10">
