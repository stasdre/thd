...
<div class="plan-full position-relative d-none d-sm-block" style="width: 100%;">
    <div class="mobile-off">
        ...
        <a href="{{$collectionData->subtitle_link}}"
            class="plan-name position-absolute btn btn-dark rounded-0">{{$collectionData->subtitle}}</a>
    </div>
...
<div class="py-2 mx-sm-3 speciality-collection">
    ...
    <div class="row mobile-off">
        <div class="col-sm-12 center">
            <div class="py-2"><a href="{{ route('advanced-search') }}"
    ...
    <div class="row desktop-off center">
        <a href="{{ route('styles') }}"
            class="btn btn-primary rounded-0 text-white font-weight-semi-bold new_style ">SEARCH
                ...
                <div class="col-sm-4 col-md-6 col-xl-4">
                    <div class="plan-grid position-relative house-grid"> <a
                            ...
                            <div class="embed-responsive embed-responsive-4by3 percent-70">
                                @if($collection->image)
                                <img src="{{asset('storage/collections/thumb/'.$collection->image)}}"
                                    alt="{{ $collection->name }}" class="embed-responsive-item" />
                                @else
                                <img src="{{asset('images/plan-1.jpg')}}" alt="{{ $collection->name }}"
