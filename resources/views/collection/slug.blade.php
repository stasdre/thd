...
<div class="row align-items-center style-desc-container">
    <div class="col-sm-7">
        <h1 class="text-center h3 font-weight-bold">{{ $collection->name }}</h1>
        <div class="sidebar-box">
            <div class="sidebar-box__text">{!! $collection->description !!}</div>
        </div>
    ...
    <div class="col-sm-12 center">
        <div><button class="btn btn-primary rounded-0 text-white font-weight-semi-bold with_padding" type="button">
            ...
            <a href="{{ route('advanced-search') }}"
                ...
                style="padding : 10px 34px;"> Advanced Plan Search</a>
        </div>
    </div>
</div>
...
<div id="plans_search" class="search-results" v-cloak :class="{loading: isLoading}">
                    ...
                    <div class="col-6">
                        <div class="form-group text-left m-0">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control rounded-0 border-secondary"
            ...
            <div class="col-sm-5 col-md-12 col-lg-5 ">
                <div class="text-center text-sm-right search_pagination">
                    <ul class="list-inline m-0 paging">
                        ...
                        <li class="list-inline-item">
                            <input type="text" class="form-control rounded-0" @keyup.enter="goToPage"
    ...
    <div class="desktop-off">
        ...
        <div class="row page-name sort-by-sec">
            <div class="col-6">
                <span>SORT BY <button style="font-size:12px;padding : 0;"><i
                            class="fa fa-caret-down"></i></button></span>
            </div>
        ...
        <div class="row ind_search_div">
            ...
            <div class="col-6"> <input type="text" placeholder="Nickname" style="width : 75%"
                    class="save_search_box"><button
            ...
            <div class="plan-list mt-3">
                ...
                <div class="position-relative">
                    <div :id="'plan'+plan.id" class="carousel slide" data-ride="carousel" data-interval="false">
                        ...
                        <a class="carousel-control-prev" @click.prevent="" :href="'#plan'+plan.id" role="button"
                            data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="false"></span> <span
                                class="sr-only">Previous</span> </a> <a class="carousel-control-next" @click.prevent=""
                            :href="'#plan'+plan.id" role="button" data-slide="next"> <span
                    ...
                    <div class="media planinfo text-left position-absolute placeholder-black"> <img
                            class="mr-1 align-self-center" src="{{asset('images/icons/logo-placeholder.png')}}"
                    ...
                    <a href="#" class="position-absolute pinterest"><img
                            src="{{asset('images/icons/icon-pinterest.png')}}" alt=""></a>
                </div>
