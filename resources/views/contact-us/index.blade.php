    ...
    <div class="px-5 mt-3 no-margins-on-mobile no-margin-top">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-8">
                ...
                <div class="center mt-2 mt-20 font-weight-bold font-10"><a href="" style="color :black;text-decoration:underline;">Read these commonly asked house plan questions</a></div>
                <div class="tab-content mt-20  contact-form" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                                    {{ Form::label('phone', 'Phone', ['for' => 'phone']) }} &nbsp;&nbsp;{{ Form::checkbox('text_me', 1) }}<span class="font-weight-bold font-10 blue-text" style="font-size : 12px;"> Text me house plan information</span>
                    ...
                    <div class="row mobile-off">
                        <div class="col-sm-6 text-right">
                            <button class="btn btn-primary rounded-0 mb-3 px-4" style="padding-left : 39px !important;padding-right : 39px !important;">Quick Plan Search</button>
                        </div>
                        <div class="col-sm-6">
