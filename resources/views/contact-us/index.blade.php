    ...
    <div class="col-sm-12 col-md-8">
      ...
      <div class="tab-content mt-20  contact-form" id="myTabContent">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                ...
                &nbsp;&nbsp;{{ Form::checkbox('text_me', 1) }}<span class="font-weight-bold font-10 blue-text"
                  style="font-size : 12px;"> Text me house plan information</span>
        ...
        <div class="row desktop-off">
          ...
          <div class="col-6 col-sm-6 set-left center">
            <button class="btn btn-primary rounded-0 text-white font-weight-semi-bold with_padding" type="button">
