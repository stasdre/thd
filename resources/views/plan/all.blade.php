...
@section('title', 'House plans by David Wiggins, Architect')
@section('description', 'Home designs and house plans by David Wiggins, find beautiful, easy to customize blueprints and
floor plans and order all plans direct from David Wiggins, Architect')
...
<div style="color : #212529;" class="info_text py-2 px-sm-5 mx-sm-3">
    ...
    <span class="mobile-off" id="content-scroll">find house plans designed by best-selling architects by following a few
        ...
        To have your questions answered by our team of house plan experts, simply <a
            href="{{ route('contact-us') }}">email</a> or <a href="{{ route('contact-us') }}">live chat</a> us
        today!</span>
</div>
