...
<div id="plan_page">
      ...
      <div class="col-10 xs_portrait_width_100">
        ...
        <div class="slider">
          ...
          <figure class="slider_max_height_500">
            <img src="{{ asset('storage/plans/'.$plan->id.'/'.$image->file_name) }}" alt="{{$image->alt_text}}"
              class="img-fluid img_width_100_percent">
        ...
        <div class="slider-nav-thumbnails xs-hide-portrait">
          @foreach($plan->images as $image)
          <div><img src="{{ asset('storage/plans/'.$plan->id.'/thumb/'.$image->file_name) }}" alt="{{$image->title}}"
              class="img-fluid"> </div>
          @endforeach
        </div>
      </div>
  ...
  <div class="px-4 position-relative padding-botton_0_xs mt-4 mb-4 trim-margin-mobile">
    ...
    <div class="row text-center align-items-center mrgn_btm">
      <div class="col-lg-6 col-sm-12 border-right_3 plan_details">
        ...
        <div class="py-2 px-5 font-weight-bold">
          <div class="row text-center no-gutters">
            <div class="col py-1 border border-light font-weight-semi-bold">Sq. Ft. <span
                class="d-block text-secondary">{{$plan->square_ft['str_total']}}</span></div>
            <div class="col py-1 border border-light font-weight-semi-bold bg-secondary">1st Fl <span
                class="d-block text-white">{{$plan->square_ft['1_floor']}}</span></div>
            <div class="col py-1 border border-light font-weight-semi-bold">2nd Fl <span
                class="d-block text-secondary">{{$plan->square_ft['2_floor']}}</span></div>
          ...
          <div class="row text-center no-gutters">
            ...
            <div class="col py-1 border border-light font-weight-semi-bold bg-secondary">Width <span
                class="d-block text-white">{{$plan->dimensions['width_ft']}}' {{$plan->dimensions['width_in']}}"</span>
            </div>
        ...
        <a href="#floorPlan" class="btn btn-primary text-uppercase rounded-0 mt-3 mobile-off">View Floor Plans</a>
      </div>
                ...
                <div class="option-wrapper">
                  <div class="btn-group btn-block select-custom white_back" id="plan-">
                    ...
                    <ul class="plan2-dropdown-menu" :class="{active: viewPackages}">
                      <li v-for="package in packages" :key="package.id" @click="setActivePackage(package)"
                        :class="{selected: checkedPackage.id === package.id}">
                        <div class="clearfix">
                          <i class="fa fa-check pull-left"></i><span class="pull-left">@{{package.name}}</span> <span
      ...
      <span class="caret"></span> -->
                    ...
                    <ul class="plan2-dropdown-menu" :class="{active: viewOptions}">
                      ...
                      <li v-for="option in options" :key="option.id" @click="setActiveOption(option)"
                        :class="{selected: checkedOption.id === option.id}">
                        <div class="clearfix">
                          <i class="fa fa-check pull-left"></i><span class="pull-left">@{{option.name}}</span> <span
  ...
  <div class="">
    <ul class="nav nav-pills plan-nav nav-justified text-uppercase mt-2" id="planDetails" role="tablist">
      <li class="nav-item xs-hide-portrait"> <a class="nav-link rounded-0 active" id="plandescription" data-toggle="tab"
          href="#planDescription" role="tab">Plan Description</a> </li>
      <li class="nav-item xs-hide-portrait"> <a class="nav-link rounded-0" id="planspecifications" data-toggle="tab"
          href="#planSpecifications" role="tab">Plan Specifications</a> </li>
      ...
      <li class="nav-item desktop-off"> <a class="nav-link rounded-0" id="reverse" data-toggle="tab" href="#reverse"
          role="tab">Reverse</a> </li>
      <li class="nav-item border-left-xs mobile-off"> <a class="nav-link rounded-0" id="costbuild" data-toggle="tab"
        ...
        <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            ...
            <p><span class=""><b>Dimensions:</b></span><span class="text_paddindLeft"> Width:
                ...
                {{$plan->dimensions['depth_in']}}"</span><span class="text_paddindLeft mNewline"> Height:
                {{$plan->dimensions['height_ft']}}' {{$plan->dimensions['height_in']}}"</span></p>

            <p><span class=""><b>Garages:</b></span><span class="text_paddindLeft"> {{$plan->garage['car']}} car;
          ...
          <div class="col-lg-12">
            ...
            <p><span class=""><b>Foundation:</b></span><span class="text_paddindLeft">
                {{ implode(', ', $plan->construction['found_type'])}}</span><span class="text_paddindLeft"><br></span>
            </p>
            @endisset
            ...
            <p class="small_bottomTxt mobile_txt">*Total heated does not include garages, porches/patios or bonus rooms
            </p>
          ...
          <div class="carousel slide" data-ride="carousel" data-interval="false" id="carouselPlan">
            <div class="carousel-inner">
              ...
              <div class="carousel-item {{ $loop->index === 0 ? 'active' : ''}}"> <img
                  src="{{asset('storage/plans/'.$plan->id.'/'.$image->file_name)}}" alt="{{ $image->alt_text }}"
                  class="img-fluid d-block w-100"> </div>
              @endforeach
              @foreach($plan->images_second as $image)
              <div class="carousel-item"> <img src="{{asset('storage/plans/'.$plan->id.'/'.$image->file_name)}}"
    ...
    <div class="tab-content px-5 py-3 mt-2 mobile-off" id="myTabContent" style="background-color: #d0d2d4 !important;">
      ...
      <div class="tab-pane fade" id="planSpecifications" role="tabpanel">
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-4 p_padd_0">
            ...
            <p><span class="left_boldTxt" style="color: transparent;">..</span><span class="text_paddindLeft">Height:
                {{$plan->dimensions['height_ft']}}' {{$plan->dimensions['height_in']}}"</span></p>
            <p><span class="left_boldTxt"><b>Garages</b></span><span class="text_paddindLeft">{{$plan->garage['car']}}
          ...
          <div class="col-sm-6 col-lg-4">
            ...
            <p><span class="left_boldTxt"><b>Foundation</b></span><span
                class="text_paddindLeft">{{ implode(', ', $plan->construction['found_type'])}}</span></p>
            @endisset
            <p><span class="left_boldTxt" style="color: transparent;">..</span><span class="text_paddindLeft"></span>
            </p>
            <p><span class="left_boldTxt"><b>Ceiling Height</b></span><span class="text_paddindLeft">
                {{ $plan->ceiling['celing_1_floor'] ? '1st floor: '.$plan->ceiling['celing_1_floor'].';' : '' }}</span><span
                class="text_paddindLeft mNewline">
      ...
      <div class="tab-pane fade" id="costBuild" role="tabpanel">
        <div class="row">
          ...
          <div class="col-lg-8 text-center">
            <h5 class="font-weight-bold">Find Out the Cost-to-Build this Home! </h5>
            <p><b>Quickly + Instantly</b> calculate the cost-to-build this home. This report will estimate the costs
              based
              on your building location, materials and labor. You can select the construction quality levels to
              ensure you stay in budget, economy, standard and premium.</p>
            <p><a href="#" class="text-primary font-weight-bold free_videoLink">View a FREE demo </a></p>
  ...
  <ul class="nav nav-pills nav-justified text-uppercase mt-2 xs-hide-portrait" id="floorPlan" role="tablist">
    ...
    <li class="nav-item"> <a class="nav-link rounded-0" id="car-options" data-toggle="tab" href="#cars" role="tab">3-Car
        Option</a> </li>
    @endif
  </ul>
