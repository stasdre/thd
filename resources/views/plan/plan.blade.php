...
<div id="plan_page">
    <div class="bg-dark pb-2 position-relative padding-botton_0_xs">
        <div class="row no-gutters">
            ...
            <div class="col-10 xs_portrait_width_100">
                ...
                <div class="slider">
                    ...
                    <figure class="slider_max_height_500">
                        <img src="{{ asset('storage/plans/'.$plan->id.'/'.$image->file_name) }}"
                            alt="{{$image->alt_text}}" class="img-fluid img_width_100_percent">
                        @if($image->description)
                        <figcaption>{{$image->description}}</figcaption>
                        @endif
                        <div class="media planinfo text-left logo_ontop"> <img class="mr-1 align-self-end"
                            ...
                            <div class="media-body">
                                ...
                                <h5 class="m-0 text-white">houseplans<span
                                        class="text-secondary">bydavidwiggins.com</span></h5>
                            </div>
                        </div>
                    </figure>
                    @endforeach
                ...
                <div class="slider-nav-thumbnails xs-hide-portrait">
                    @foreach($plan->images as $image)
                    <div><img src="{{ asset('storage/plans/'.$plan->id.'/thumb/'.$image->file_name) }}"
                            alt="{{$image->title}}" class="img-fluid"> </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="left preferred position-absolute pl-2 xs-hide-portrait">
            <!--d-sm-none-->
        ...
        <div class="right position-absolute text-sm-right newsletter pr-2 mb-1 xs-hide-portrait">
            <!--d-sm-none-->
            ...
            <div class="input-group input-group-sm">
                ...
                <div class="input-group-append">
                    <button class="btn btn-secondary rounded-0 text-uppercase text-dark font-weight-semi-bold"
        ...
        <div class="row text-center align-items-center mrgn_btm">
            <div class="col-lg-6 col-sm-12 border-right_3 plan_details">
                ...
                <div class="py-2 px-5 font-weight-bold">
                    ...
                    <div class="row text-center no-gutters">
                        <div class="col py-1 border border-light font-weight-semi-bold bg-secondary">Beds <span
                                class="d-block text-white">{{$plan->rooms['r_bedrooms']}}</span></div>
                        <div class="col py-1 border border-light font-weight-semi-bold">Baths <span
                                class="d-block text-secondary">{{$plan->rooms['r_full_baths']}}</span></div>
                        <div class="col py-1 border border-light font-weight-semi-bold bg-secondary">Width <span
                                class="d-block text-white">{{$plan->dimensions['width_ft']}}'
                                {{$plan->dimensions['width_in']}}"</span>
                        </div>
                        <div class="col py-1 border border-light font-weight-semi-bold">Depth <span
                                class="d-block text-secondary">{{$plan->dimensions['depth_ft']}}'
                                {{$plan->dimensions['depth_in']}}"</span></div>
                    </div>
                </div>
                <a href="#floorPlan" class="btn btn-primary text-uppercase rounded-0 mt-3 mobile-off">View Floor
                    Plans</a>
            </div>
                            ...
                            <div class="form-group mb-0">
                                <div class="option-wrapper">
                                    <div class="btn-group btn-block select-custom white_back" id="plan-">
                                        <button @click="viewPackages = !viewPackages"
                                            class="btn btn-lg btn-block clearfix dropdown-plans option-button option-button1">
                                            <span
                                                class="selected-plan-set pull-left font-size-ipad font-size-15"><strong>@{{checkedPackage.name ? checkedPackage.name : 'Choose Plan Package'}}</strong></span>
                                            <span class="pull-right opt_select-styled">
                                                <!-- <i class="fas fa-chevron-down"></i> -->
                                            </span>
                                            <span class="pull-right option-price"><span
                                                    class="selected-plan-set-price font-size-ipad">@{{checkedPackage.price ? '$'+checkedPackage.price : ''}}</span></span>
                                        </button>
                                        <ul class="plan2-dropdown-menu" :class="{active: viewPackages}">
                                            <li v-for="package in packages" :key="package.id"
                                                @click="setActivePackage(package)"
                                                :class="{selected: checkedPackage.id === package.id}">
                                                <div class="clearfix">
                                                    <i class="fa fa-check pull-left"></i><span
                                                        class="pull-left">@{{package.name}}</span> <span
                                                        class="pull-right">$@{{package.price}}</span>
                                                </div>
                    ...
                    <div class="row align-items-center no-gutters mb-1">
                        ...
                        <div class="col-9 text-left">
                            <div class="form-group mb-0">
                                <div class="option-wrapper">
                                    <div class="btn-group btn-block select-custom white_back" id="plan-">
                                        <button @click="viewOptions = !viewOptions"
                                            class="btn btn-lg btn-block clearfix dropdown-plans option-button option-button2">
                                            <span
                                                class="selected-foundation selected-value pull-left font-size-ipad font-size-15"><strong>@{{checkedOption.name ? checkedOption.name : 'Choose Foundation'}}</strong></span>
                                            <span class="pull-right opt_select-styled">
                                                <!-- <span class="caret caret-reversed"></span>
      <span class="caret"></span> -->
                                            </span>
                                            <span class="pull-right option-price"><span
                                                    class="selected-foundation-price font-size-ipad">@{{checkedOption.price ? '+$'+checkedOption.price : ''}}</span></span>
                                        </button>
                                        <ul class="plan2-dropdown-menu" :class="{active: viewOptions}">

                                            <li v-for="option in options" :key="option.id"
                                                @click="setActiveOption(option)"
                                                :class="{selected: checkedOption.id === option.id}">
                                                <div class="clearfix">
                                                    <i class="fa fa-check pull-left"></i><span
                                                        class="pull-left">@{{option.name}}</span> <span
                                                        class="pull-right">+$@{{option.price}}</span>
                                                </div>
                    ...
                    <div class="row align-items-center no-gutters mb-1">
                        ...
                        <div class="col-9 text-left">
                            <div class="form-group mb-0">
                                <button @click="viewAddons = !viewAddons" id="additional-options"
                                    class="btn-group btn-block select-custom white_back">
                                    <span class="pull-left"><strong class="font-size-15 font-size-ipad">Optional
                    ...
                    <div class="subtotals">
                        <div class="row align-items-center no-gutters mb-1">
                            ...
                            <div class="col-9 text-left font-weight-bold margin_left position_unset">SUBTOTALS:<span>
                                    $@{{total}}</span></div>
                        </div>
                    </div>
            ...
            <div class="col-lg-2 col-sm-5 padd_top pd-md-0 mobile-off">
                <!--d-sm-none-->
                ...
                <div class="bg-secondary px-2 py-2 mb-1">
                    <h5 class="text-primary"><a href="/blog/whats-included-in-a-stock-house-plan-set"
    ...
    <div class="tab-content bg-secondary px-5 py-3 desktop-off" id="myTabContent">
        <div class="tab-pane fade show active" id="" role="tabpanel">
            ...
            <p class="margin_bt0-xs">{!! substr($plan->description, 0, 355) !!}<span class="mobile-off"
                    id="content-scroll">{!! substr($plan->description, 356) !!}</span></p>
            <div class="desktop-off read_more" id="read_more"><span class="read-more-link-wrapper">Read More </span>
            </div>
        ...
        <div class="tab-pane fade" id="costBuild1" role="tabpanel">
            <div class="row">
                ...
                <div class="col-lg-8 text-center">
                    ...
                    <p><b>Quickly + Instantly</b> calculate the cost-to-build this home. This report will estimate the
                        costs based
                        on your building location, materials and labor. You can select the construction quality levels
                        to
                    ...
                    <span class="note text-danger">Note: The Home-Cost Instant Cost-to-Build Estimator purchase is
                        non-refundable.</span>
                </div>
                <div class="col-lg-2 text-center">
    ...
    <div class="">
        <ul class="nav nav-pills plan-nav nav-justified text-uppercase mt-2" id="planDetails" role="tablist">
            <li class="nav-item xs-hide-portrait"> <a class="nav-link rounded-0 active" id="plandescription"
                    data-toggle="tab" href="#planDescription" role="tab">Plan Description</a> </li>
            <li class="nav-item xs-hide-portrait"> <a class="nav-link rounded-0" id="planspecifications"
                    data-toggle="tab" href="#planSpecifications" role="tab">Plan Specifications</a> </li>
            <li class="nav-item xs-hide-portrait"> <a class="nav-link rounded-0" id="planfeatures" data-toggle="tab"
                    href="#planFeatures" role="tab">Plan <span class="d-sm-block d-md-inline">Features</span></a> </li>
            <li class="nav-item border-right-xs"> <a class="nav-link rounded-0" id="modifyplan" target="_blank"
                    href="{{ route('modify-plan', $plan->plan_number) }}">Modify <span class="xs-hide-portrait"> This
                        Plan</span></a> </li>

            <li class="nav-item desktop-off"> <a class="nav-link rounded-0" id="reverse" data-toggle="tab"
                    href="#reverse" role="tab">Reverse</a> </li>
            <li class="nav-item border-left-xs mobile-off"> <a class="nav-link rounded-0" id="costbuild"
                    data-toggle="tab" href="#costBuild" role="tab">Cost to <span
                        class="d-sm-block d-md-inline">Build</span></a> </li>
            <li class="nav-item border-left-xs desktop-off"> <a class="nav-link rounded-0" id="costbuild1"
                    data-toggle="tab" href="#costBuild1" role="tab">Cost to Build</span></a> </li>
        ...
        <div class="only_under_767 desktop-off">
            ...
            <div class="row collapse in tab-content bg-secondary_new py-3" id="ViewallPlans">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        <p><span><b>Beds/Bath:</b></span><span class="text_paddindLeft"> Bedrooms:
                                {{$plan->rooms['r_bedrooms']}}</span> <span class="text_paddindLeft mNewline">Baths:
                                {{$plan->rooms['r_full_baths']}}</span></p>
                        <p><span class=""><b>Dimensions:</b></span><span class="text_paddindLeft"> Width:
                                {{$plan->dimensions['width_ft']}}' {{$plan->dimensions['width_in']}}"</span><span
                                class="text_paddindLeft mNewline">Depth: {{$plan->dimensions['depth_ft']}}'
                                {{$plan->dimensions['depth_in']}}"</span><span class="text_paddindLeft mNewline">
                                Height:
                                {{$plan->dimensions['height_ft']}}' {{$plan->dimensions['height_in']}}"</span></p>

                        <p><span class=""><b>Garages:</b></span><span class="text_paddindLeft"> {{$plan->garage['car']}}
                                car;
                                {{$plan->square_ft['garage']}} s.f.</span></p>
                        <p><span class=""><b>Roof:</b></span><span class="text_paddindLeft">
                                {{$plan->construction['roof_frame']}}</span></p>
                        <p><span class=""><b>Exterior Walls:</b></span><span class="text_paddindLeft">
                                {{$plan->construction['ext_walls']}}</span></p>
                    </div>
                    <div class="col-lg-12">
                        @isset ($plan->construction['found_type'])
                        <p><span class=""><b>Foundation:</b></span><span class="text_paddindLeft">
                                {{ implode(', ', $plan->construction['found_type'])}}</span><span
                                class="text_paddindLeft"><br></span>
                        </p>
                        @endisset

                        <p><span class="left_boldTxt"><b>Ceiling Height: </b></span><span class="text_paddindLeft">
                                {{ $plan->ceiling['celing_1_floor'] ? '1st floor: '.$plan->ceiling['celing_1_floor'].';' : '' }}</span><span
                                class="text_paddindLeft mNewline">
                                {{ $plan->ceiling['celing_2_floor'] ? '2nd floor: '.$plan->ceiling['celing_2_floor'].';' : '' }}</span>
                            <span class="text_paddindLeft mNewline">
                                {{ $plan->ceiling['celing_3_floor'] ? '3rd floor: '.$plan->ceiling['celing_3_floor'].';' : '' }}</span>
                            <span class="text_paddindLeft mNewline">
                                {{ $plan->ceiling['celing_lower_floor'] ? 'Lower level: '.$plan->ceiling['celing_lower_floor'].';' : '' }}</span>
                        </p>
                        <p class="small_bottomTxt mobile_txt">*Total heated does not include garages, porches/patios or
                            bonus rooms
                        </p>
            ...
            <p class="text-center px-5"><a href="#" class="btn btn-primary rounded-0 mt-3" data-toggle="collapse"
                    data-target="#ViewallPlans">View ALL plan details</a></p>

            <div class="row">
                <div class="col-md-12">
                    <div class="text-center text-uppercase lead font-weight-normal align-middle py-2"
                        style="font-size: 19px;"> <a href="{{ route('contact-us') }}"
                            class="align-middle text-primary">Live Chat</a> | <a href="{{ route('contact-us') }}"
                            class="align-middle text-primary">Email</a> | <a href="tel:832-521-5820"
                    ...
                    <div class="carousel slide" data-ride="carousel" data-interval="false" id="carouselPlan">
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{ $loop->index === 0 ? 'active' : ''}}"> <img
                                    ...
                                    alt="{{ $image->alt_text }}" class="img-fluid d-block w-100"> </div>
                            @endforeach
                        ...
                        <a class="carousel-control-prev" href="#carouselPlan" role="button" data-slide="prev"> <span
                                class="carousel-control-prev-icon" aria-hidden="true"></span> <span
                                class="sr-only">Previous</span> </a>
                        <a class="carousel-control-next" href="#carouselPlan" role="button" data-slide="next"> <span
                                class="carousel-control-next-icon" aria-hidden="true"></span> <span
                                class="sr-only">Next</span> </a>
                    </div>

                </div>
                <div class="col-lg-2 col-sm-5 padd_top pd-md-0">
                    <!--d-sm-none-->
                    <div class="bg-secondary px-2 py-2 mb-1">
                    ...
                    <div class="bg-secondary px-2 py-2 mb-1">
                        <h5 class="text-primary text-center buy-plan"><a
                                href="/blog/whats-included-in-a-stock-house-plan-set" target="_blank">What's Included
                                with Your Plans</a></h5>
                        <!--<p class="small m-0">The PDF Plan Package offers Immediate delivery of your House Plans!</p>-->
                    </div>
                    <div class="bg-secondary px-2 py-2">
                        <h5 class="text-primary text-center buy-plan"><a
                                href="/important-information-to-know-before-buying-house-plans"
                                target="_blank">Important Info Before
                                You Buy</a></h5>
                        <!--<p class="small m-0">The PDF Plan Package offers Immediate delivery of your House Plans!</p>-->
                    </div>
                </div>
                                    ...
                                    <div class="option-wrapper">
                                        <div class="btn-group btn-block select-custom white_back" id="plan-">
                                            <button @click="viewPackages = !viewPackages"
                                                class="btn btn-lg btn-block clearfix dropdown-plans option-button option-button1">
                                                <span
                                                    class="selected-plan-set font-size-ipad pull-left"><strong>@{{checkedPackage.name ? checkedPackage.name : 'Choose Plan Package'}}</strong></span>
                                                <span class="pull-right opt_select-styled">
                                                    <!-- <i class="fas fa-chevron-down"></i> -->
                                                </span>
                                                <span class="pull-right option-price"><span
                                ...
                                <div class="form-group mb-0">
                                    <div class="option-wrapper">
                                        <div class="btn-group btn-block select-custom white_back" id="plan-">
                                            <button @click="viewOptions = !viewOptions"
                                                class="btn btn-lg btn-block clearfix dropdown-plans option-button option-button2">
                                                <span class="selected-foundation font-size-ipad"
                                                    class="selected-value pull-left"><strong>@{{checkedOption.name ? checkedOption.name : 'Choose Foundation'}}</strong></span>
                                                <span class="pull-right opt_select-styled">
                                                    <!-- <span class="caret caret-reversed"></span>
      <span class="caret"></span> -->
                                                </span>
                        ...
                        <div class="row align-items-center no-gutters mb-1">
                            ...
                            <div class="col-9 text-left">
                                <div class="form-group mb-0">
                                    <button @click="viewAddons = !viewAddons" id="additional-options_mob"
                                        class="btn-group btn-block select-custom white_back">
                                        <span class="pull-left"><strong class="font-size-15 font-size-ipad">Optional
                                                Features</strong></span>
                                        <span class="pull-right opt_select-styled"></span>
                        ...
                        <div class="subtotals">
                            <div class="row align-items-center no-gutters mb-1">
                                <div class="col-1 text-right pr-1"></div>
                                <div class="col-9 text-left font-weight-bold margin_left position_unset">
                                    SUBTOTALS:<span>
                                        $@{{total}}</span></div>
                            </div>
                        </div>
        ...
        <div class="tab-content px-5 py-3 mt-2 mobile-off" id="myTabContent"
            style="background-color: #d0d2d4 !important;">
            ...
            <div class="tab-pane fade" id="planSpecifications" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-4 p_padd_0">
                        <p><span class="left_boldTxt"><b>Beds/Bath</b></span><span class="text_paddindLeft">Bedrooms:
                                {{$plan->rooms['r_bedrooms']}}</span> <span class="text_paddindLeft">Baths:
                                {{$plan->rooms['r_full_baths']}}</span></p>
                        <p><span class="left_boldTxt"><b>Dimensions</b></span><span class="text_paddindLeft">Width:
                                {{$plan->dimensions['width_ft']}}' {{$plan->dimensions['width_in']}}"</span><span
                                class="text_paddindLeft">Depth: {{$plan->dimensions['depth_ft']}}'
                                {{$plan->dimensions['depth_in']}}"</span></p>
                        <p><span class="left_boldTxt" style="color: transparent;">..</span><span
                                class="text_paddindLeft">Height:
                                {{$plan->dimensions['height_ft']}}' {{$plan->dimensions['height_in']}}"</span></p>
                        <p><span class="left_boldTxt"><b>Garages</b></span><span
                                class="text_paddindLeft">{{$plan->garage['car']}}
                                car; {{$plan->square_ft['garage']}} s.f.</span></p>
                        <p><span class="left_boldTxt"><b>Roof</b></span><span
                                class="text_paddindLeft">{{$plan->construction['roof_frame']}}</span></p>
                        <p><span class="left_boldTxt"><b>Exterior Walls</b></span><span
                                class="text_paddindLeft">{{$plan->construction['ext_walls']}}</span></p>
                    </div>
                    <div class="col-sm-6 col-lg-4">

                        @isset ($plan->construction['found_type'])
                        <p><span class="left_boldTxt"><b>Foundation</b></span><span
                                class="text_paddindLeft">{{ implode(', ', $plan->construction['found_type'])}}</span>
                        </p>
                        @endisset
                        <p><span class="left_boldTxt" style="color: transparent;">..</span><span
                                class="text_paddindLeft"></span>
                        </p>
                        <p><span class="left_boldTxt"><b>Ceiling Height</b></span><span class="text_paddindLeft">
                                {{ $plan->ceiling['celing_1_floor'] ? '1st floor: '.$plan->ceiling['celing_1_floor'].';' : '' }}</span><span
                                class="text_paddindLeft mNewline">
                        ...
                        <p class="small_bottomTxt">*Total heated does not include garages, porches/patios or bonus rooms
                        </p>
            ...
            <div class="tab-pane fade" id="costBuild" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-lg-8 text-center">
                        <h5 class="font-weight-bold">Find Out the Cost-to-Build this Home! </h5>
                        <p><b>Quickly + Instantly</b> calculate the cost-to-build this home. This report will estimate
                            the costs
                            based
                            on your building location, materials and labor. You can select the construction quality
                            levels to
                            ensure you stay in budget, economy, standard and premium.</p>
                        <p><a href="#" class="text-primary font-weight-bold free_videoLink">View a FREE demo </a></p>
                        <span class="note text-danger">Note: The Home-Cost Instant Cost-to-Build Estimator purchase is
    ...
    <ul class="nav nav-pills nav-justified text-uppercase mt-2 xs-hide-portrait" id="floorPlan" role="tablist">
        ...
        <li class="nav-item"> <a class="nav-link rounded-0 active" id="first-floor" data-toggle="tab" href="#first"
                role="tab">First Floor Plan</a> </li>
        @endif
        @if($plan->images_second->count())
        <li class="nav-item"> <a class="nav-link rounded-0" id="second-floor" data-toggle="tab" href="#second"
                role="tab">Second Floor Plan</a> </li>
        @endif
        @if($plan->images_basement->count())
        <li class="nav-item"> <a class="nav-link rounded-0" id="basement-floor" data-toggle="tab" href="#basement"
                role="tab">Basement Floor Plan</a> </li>
        @endif
        @if($plan->images_bonus->count())
        <li class="nav-item"> <a class="nav-link rounded-0" id="bonus-floor" data-toggle="tab" href="#bonus"
                role="tab">Bonus Floor Plan</a> </li>
        @endif
        @if($plan->images_cars->count())
        <li class="nav-item"> <a class="nav-link rounded-0" id="car-options" data-toggle="tab" href="#cars"
                role="tab">3-Car
                Option</a> </li>
        @endif
    </ul>
            ...
            <div class="col-lg-10 m-auto">
                ...
                <div class="row mobile-off">
                    ...
                    <div class="col-md-6 text-center">
                        <a target="_blank" href="/blog/whats-included-in-a-stock-house-plan-set"
                            title="{{ $image->alt_text }}">
                            <h6 class="font-weight-bold mb-0" style="line-height: 40px;color:#000">Download Sample
                                Construction Plans
                            </h6>
                        </a>
                    </div>
                    <div class="col-md-3 text-right text-xs-center custom_reversePlan"><button type="button"
                            class="btn btn-dark rounded-0 reverse_plan">Reverse plan</button></div>
                </div>
                <div class="row mobile-off">
                    <div class="col-md-12">
                    ...
                    <div class="plan-grid">
                        <a href="{{route('plan.view', $item->plan_number)}}">
                            <div class="position-relative">
                                <div id="plan{{$item->plan_number}}" data-ride="carousel" data-interval="false"
                                    class="carousel slide">
                                    <div class="carousel-inner">
                                        @foreach ($item->images as $img)
                                        <div class="carousel-item @if($loop->iteration === 1) active @endif">
                                            <img src="{{ asset('storage/plans/'.$item->id.'/thumb/'.$img->file_name) }}"
                                                alt="" class="img-fluid">
                                        </div>
                                        @endforeach
                                    </div>
                                    <a href="#plan{{$item->plan_number}}" role="button" data-slide="prev"
                                        class="carousel-control-prev"><span aria-hidden="false"
                                            class="carousel-control-prev-icon"></span>
                                        <span class="sr-only">Previous</span></a>
                                    <a href="#plan{{$item->plan_number}}" role="button" data-slide="next"
                                        class="carousel-control-next"><span aria-hidden="false"
