    ...
    <div class="col-lg-12">
        <div class="row">
                ...
                <div class="form-group {{ $errors->has('foundation') ? 'has-error' : '' }} col-lg-6 pull-left">
                    <div class="select-custom-wrap select-custom-wrap-lg">
                        ...
                        {{ Form::select('foundation', [
                              ...
                              'Daylight Basement'=>'Daylight Basement', 
                              ], null, ['class'=>'select-custom select-custom-jq', 'placeholder'=>'Select here']) }}
                    </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('land') ? 'has-error' : '' }} col-lg-6 pull-left">
                    <div class="select-custom-wrap select-custom-wrap-lg">
                        ...
                        {{ Form::select('land', [
                              'Yes'=>'Yes', 
                              'No'=>'No', 
                              'In process of purchasing'=>'In process of purchasing', 
                              'Have multiple lots'=>'Have multiple lots', 
                              ], null, ['class'=>'select-custom select-custom-jq', 'placeholder'=>'Select here']) }}
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="row align-items-center py-2 px-1">
                        <div class="col-8">
                            <p class="plan-name font-weight-bold mb-0">{{$plan->square_ft['str_total']}} sq ft | <span
                                    class="text-white"><a style="color:inherit"
                                        href="{{route('plan.view', $plan->plan_number)}}">plan
                                        {{$plan->plan_number}}</a></span></p>
                        </div>
                        <div class="col-4">
                            <ul class="list-inline mb-0 text-right">
                                <li class="list-inline-item"><a href=""><img src="/images/icons/icon-favourite.png"
                                            alt=""></a></li>
                                <li class="list-inline-item">
                                    <button type="button" class="btn btn-link p-0" data-toggle="modal"
                                        data-target="#quickView"><img src="/images/icons/icon-search-w.png"
                                            alt=""></button>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div id="plan{{$plan->plan_number}}" class="carousel slide" data-ride="carousel"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item @if($loop->iteration == 1) active @endif">
                                        <img src="/storage/plans/{{$plan->id}}/thumb/{{$img->file_name}}"
                                            alt="{{$plan->name}}" class="img-fluid d-block w-100">
                                        @if($img->camera_icon)
                ...
                <img src="{{asset('storage/plans/'.$plan->id.'/thumb/'.$image->file_name)}}"
                    class="img-fluid d-block w-100" alt="First Floor Plan">
                <p class="plan_download_link"><a download="first-floor-Plan.png"
                        href="{{asset('storage/plans/'.$plan->id.'/'.$image->file_name)}}"
                ...
                <img src="{{asset('storage/plans/'.$plan->id.'/thumb/'.$image->file_name)}}"
                    class="img-fluid d-block w-100" alt="Second Floor Plan">
                <p class="plan_download_link"><a download="first-floor-Plan.png"
                        href="{{asset('storage/plans/'.$plan->id.'/'.$image->file_name)}}"
                        title="{{$image->file_name}}">
                        Click to enlarge and download
